        ...
        <Box className={'w-full h-screen bg-[#F3F6F7]'}>
            <Box className={'bg-[#ffffff] px-24 py-16'}>
                <Box className={'bg-[#ffffff] w-96 flex-col'} shadow>
                    ...
                    <Input label="Name" onChange={(e)=>{getData(e,setName)}} />
                    <Input label="Email" onChange={(e)=>{getData(e,setEmail)}} />
                    <Input label="Password" onChange={(e)=>{getData(e,setPass)}} password />
